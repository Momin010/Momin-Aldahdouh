...
const DatabaseCanvas: React.FC<DatabaseCanvasProps> = ({
  ...
  return (
    <div className="relative h-full bg-gray-50 overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-20 flex gap-2">
        ...
        <button
          ...
          className={`p-2 rounded-lg shadow transition-colors ${
            showGrid ? 'bg-blue-600 text-white' : 'bg-white hover:bg-gray-50'
          }`}
          title="Toggle Grid"
        >
        ...
        <button
          ...
          className={`p-2 rounded-lg shadow transition-colors ${
            showRelationships ? 'bg-blue-600 text-white' : 'bg-white hover:bg-gray-50'
          }`}
        ...
        {onAddTable && (
          <button
            onClick={onAddTable}
            className="p-2 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition-colors"
            title="Add Table"
          >
            <Icon name="plus" className="w-4 h-4" />
          </button>
      ...
      {/* Zoom indicator */}
      <div className="absolute top-4 right-4 z-20 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-1 shadow">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {onTableEdit && (
                    <button
                      ...
                      title="Edit table"
                    >
                      <Icon name="edit" className="w-3 h-3 text-gray-600" />
                    </button>
                  )}
                  {onTableDelete && (
                    <button
