    ...
    <div className="flex flex-col h-full bg-transparent">
       <div className="flex-shrink-0 p-3 border-b border-black/10">
        <h2 className="text-sm font-semibold flex items-center text-gray-700">
          ...
          <span className="font-mono text-purple-700">{filePath}</span>
        </h2>
      </div>
      <div className="flex-grow relative">
        <textarea
          ...
          className="w-full h-full p-4 bg-transparent text-gray-800 font-mono text-sm resize-none focus:outline-none leading-relaxed"
          spellCheck="false"
          wrap="off"
